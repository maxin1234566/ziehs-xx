<template>
  <HasFixedBottomWrapper>
    ...
    <div slot="fixedBottom">
      <FixedBottom>
        <div>
          ...
          <a-button class="m-r-15" v-if="processReview == 2" @click="backReview"
            >退回</a-button
          >
          <a-button
            type="primary"
            v-if="processReview == 2"
            class="m-r-15"
            :loading="loading"
            @click="reviewConfirm"
            >评审</a-button
    ...
    <CommonModal
      ...
      :cancelFn="reviewCancel"
      class="table-modal review-content"
    >
      <template slot="form">
        <a-form-model
          ref="reviewForm"
        ...
        >
          ...
          <template title="作业条件危险性评价">
            ...
            <a-row>
              <a-col :span="17">
                <a-form-model-item label="发生事故事件的可能性" prop="accidentsIncidents">
                  <a-select
                    v-model="reviewForm.accidentsIncidents"
                    placeholder="请选择"
              ...
              <a-col :span="7">
                <a-form-model-item label="L值" prop="lvalue">
                  <a-input
                    v-model.trim="reviewForm.lvalue"
                    :maxLength="30"
                    placeholder="自动带出"
                    :disabled="true"
                  ></a-input>
              ...
              <a-col :span="17">
                ...
                >
                  <a-select
                    v-model="reviewForm.environment"
                    placeholder="请选择"
              ...
              <a-col :span="7">
                <a-form-model-item label="E值" prop="evalue">
                  <a-input
                    v-model.trim="reviewForm.evalue"
                    :maxLength="30"
                    placeholder="自动带出"
                    :disabled="true"
                  ></a-input>
          ...
          <template title="发生事故产生的后果">
            ...
            <a-row>
              <a-col :span="17">
                <a-form-model-item label="人员伤害" prop="personalInjury">
                  <a-select
                    v-model="reviewForm.personalInjury"
                    placeholder="请选择"
              ...
              <a-col :span="7">
                <a-form-model-item label="(C-人)值" prop="cvaluep">
                  <a-input
                    v-model.trim="reviewForm.cvaluep"
                    :maxLength="30"
                    placeholder="自动带出"
                    :disabled="true"
                  ></a-input>
              ...
              <a-col :span="17">
                <a-form-model-item label="生产损失" prop="productionLoss">
                  <a-select
                    v-model="reviewForm.productionLoss"
                    placeholder="请选择"
              ...
              <a-col :span="7">
                <a-form-model-item label="(C-产)值" prop="cvalues">
                  <a-input
                    v-model.trim="reviewForm.cvalues"
                    :maxLength="30"
                    placeholder="自动带出"
                    :disabled="true"
                  ></a-input>
              ...
              <a-col :span="17">
                <a-form-model-item label="C值" prop="cvalue">
                  <a-input
                    v-model.trim="reviewForm.cvalue"
                    :maxLength="30"
                    placeholder="自动带出"
                    :disabled="true"
                  ></a-input>
              ...
              <a-col :span="7">
                <a-form-model-item label="风险值" prop="valueRisk">
                  <a-input
                    v-model.trim="reviewForm.valueRisk"
                    :maxLength="30"
                    placeholder="自动带出"
                    :disabled="true"
                  ></a-input>
              ...
              <a-col :span="17">
                <a-form-model-item label="危险级别" prop="hazardLevel">
                  <a-select
                    v-model="reviewForm.hazardLevel"
                    placeholder="自动带出"
                    :disabled="true"
                  >
                    <a-select-option
              ...
              <a-col :span="7">
                <div :class="[classReviewBack]">
                  <a-form-model-item label="风险分级" prop="riskClassification">
                    <a-select
                      v-model="reviewForm.riskClassification"
                      placeholder="自动带出"
                      :disabled="true"
                    >
                      <a-select-option
          ...
          <template title="评审意见">
            <div>
              <div class="m-t-20 border-d-e7"></div>
              <div class="m-t-20"></div>
            </div>
            <a-row>
              <a-col :span="17">
              ...
              <a-col :span="17">
                <a-form-model-item label="评审意见">
                  <a-textarea
                    v-model.trim="reviewForm.reviewRemake"
                    :maxLength="300"
                    placeholder="请输入评审意见"
                  ></a-textarea>
                </a-form-model-item>
      ...
      <template slot="btn">
        ...
        <a-button type="primary" class="m-l-15" @click="confirm" :loading="confirmLoading"
          >确定</a-button
        >
      </template>
    </CommonModal>
...
import {
  ...
  reviewInfo,
  returnReview,
} from "@/services/dangerSource/dangerApprove/index.js";
  ...
  data() {
    return {
      ...
      iRules: {
        ...
        possibleEvents: [
          { required: true, message: "可能导致事件不能为空", trigger: "change" },
        ],
        partsBodyInjury: [
          { required: true, message: "可能接触伤害的部位不能为空", trigger: "change" },
        ],
        riskDescription: [
        ...
        //作业条件危险性评价
        accidentsIncidents: [
          { required: true, message: "发生事故事件的可能性不能为空", trigger: "change" },
        ],
        environment: [
          {
            required: true,
  ...
  watch: {
    iFrom: {
      ...
      handler(newVal, oldVal) {
        ...
        if (newVal.lvalue && newVal.evalue && newVal.cvalue) {
          newVal.valueRisk =
            (Number(newVal.lvalue) * 10 * Number(newVal.evalue) * Number(newVal.cvalue)) /
            10;
        }
    ...
    reviewForm: {
      ...
      handler(newVal, oldVal) {
        ...
        if (newVal.lvalue && newVal.evalue && newVal.cvalue) {
          newVal.valueRisk =
            Number(newVal.lvalue) * Number(newVal.evalue) * Number(newVal.cvalue);
        }
