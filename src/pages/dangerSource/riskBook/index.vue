  ...
  <div class="searchtable-wrapper clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
    <SearchTerm>
      <a-form-model layout="inline" :model="formInline" :colon="false">
        ...
        <a-form-model-item label="编号">
          <a-input
            v-model="formInline.riskPointNo"
            :maxLength="30"
            placeholder="请输入编号"
            allowClear
          ></a-input>
        ...
        <a-form-model-item label="风险点">
          <a-input
            v-model="formInline.riskPointName"
            :maxLength="30"
            placeholder="请输入风险点"
            allowClear
          ></a-input>
        ...
        <a-form-model-item label="危险源种类">
          <a-select
            v-model="formInline.dangerSourceType"
            placeholder="请选择"
            option-filter-prop="children"
            style="width: 200px"
            show-search
          ...
          >
            <a-select-option
              v-for="item in getChemicalDictList('wxy_hazardkind')"
              :key="item.dictValue"
        ...
        <a-form-model-item label="可能导致事件">
          <a-select
            v-model="formInline.dangerSourceEvent"
            placeholder="请选择"
            option-filter-prop="children"
            style="width: 200px"
            show-search
          ...
          >
            <a-select-option
              v-for="item in getChemicalDictList('wxy_leadtheevent')"
              :key="item.dictValue"
              :value="item.dictValue"
              >{{ item.dictLabel }}</a-select-option
            >
    ...
    <DashBtn>
      ...
      <div>
        ...
        <a-button type="primary" :loading="loadingTwo" @click="downloadTem" class="m-l-20"
          >导出Excel</a-button
        >
      </div>
    </DashBtn>
    ...
    >
      ...
      >
        <div slot="action" slot-scope="text, record">
          ...
          <span class="color-0067cc cursor-pointer" @click="goShowPage(record)"
            >查看</span
          >
          <span
            class="color-0067cc cursor-pointer"
            v-if="[1, 4].includes(record.status - 0)"
            @click="goAddChangePage('edit', record)"
            >编辑</span
          >
          <span
            class="color-0067cc cursor-pointer"
          ...
          <span
            ...
            v-if="[1, 3, 4].includes(record.status - 0)"
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          width: 150,
          customRender: (textArr) => {
            // console.log(textArr, "textArrtextArrtextArr");
            textArr = textArr ? textArr : [];
            let text = "";
  ...
  methods: {
    ...
    goAddChangePage(type, record) {
      if (type == "change") {
        ...
        let path =
          type == "add"
            ? "/safeManage/dualControlManage/riskManage/riskBookAdd"
            : "/safeManage/dualControlManage/riskManage/riskBookEdit";
