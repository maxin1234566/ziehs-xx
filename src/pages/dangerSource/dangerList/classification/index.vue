<template>
  <div class="clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
    ...
    <DashBtn>
      <div>
        <a-button type="dashed" @click="addFn"><a-icon type="plus" />新增</a-button>
      </div>
    </DashBtn>
    <CommonTable
...
export default {
  ...
  methods: {
    ...
    // 获取所有组织列表
    getOrganizationList() {
      orgGetCorporationList({}).then((res) => {
        this.organizationList = res.data;
    ...
    addConfirm() {
      ...
      let dataObj = {
        ...this.addForm,
        classificationName: dictionary("classification", this.addForm.classificationCode),
      ...
      promiseFn(dataObj)
        .then(() => {
          ...
          this.$antMessage.success(`${this.modalTitle ? "编辑成功" : "新增成功"}`);
          this.getDataList(); //获取列表
