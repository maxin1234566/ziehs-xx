      ...
      <template slot="form">
        ...
        >
          ...
          <a-form-model-item class="flex" label="公司级" prop="companyLevel">
            <a-select
              v-model="addForm.companyLevel"
              placeholder="请选择"
              prop="operationLine"
              allowClear
            >
              <a-select-option
                v-for="item in centerAreaList"
                :key="item.key"
                :value="item.key"
          ...
          <a-form-model-item class="flex" label="部门级" prop="deptParentLevel">
            <a-select
              v-model="addForm.deptParentLevel"
              placeholder="请选择"
              prop="operationLine"
              allowClear
            >
...
export default {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              align: "center",
              customRender: (text, record) => {
                return record.list.length ? this.thing(record.list, "jobLevel") : "--";
              },
            },
            {
              title: "安全管理部门",
  ...
  methods: {
    ...
    thing(list, companyLevel) {
      ...
      return list2.length
        ? dictionary("checkFrequencyLevel", list2[0].checkFrequencyLevel)
        : "--";
    },
