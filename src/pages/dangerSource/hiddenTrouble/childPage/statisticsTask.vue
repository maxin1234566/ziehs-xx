        ...
        series: [
          {
            ...
            barMaxWidth: 50,
            data: [20, 25, 76, 85, 92, 72, 40, 60, 135, 122],
          },
          {
            name: "应完成",
            type: "bar",
            ...
            barMaxWidth: 50,
            data: [16, 19, 19, 76, 88, 70, 76, 18, 47, 60],
          },
          {
            name: "完成进度",
            type: "line",
            ...
            data: [12, 22, 33, 45, 93, 72, 50, 46, 23.0, 16.5],
          },
        ],
      },
    };
    ...
    initData() {
      ...
      getStatistical({
        ...
        if (this.searchFormData.corporationId) {
          this.option.xAxis[0].data = testData.map((item) => {
        ...
        this.option.series[2].data = testData.map((item) => {
          return parseInt((item.useComplete / item.unUseComplete) * 100);
        });
      });
    },
    handleBack() {
