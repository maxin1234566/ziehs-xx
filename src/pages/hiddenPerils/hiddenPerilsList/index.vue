  ...
  <div class="clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
    <SearchTerm>
      <a-form-model layout="inline" :model="formInline" :colon="false">
        <NewCommonSearchItem ref="commonSearchItem" :CommonFormInline="formInline" :needDeptName="true" :hasDepartment="true"></NewCommonSearchItem>
        <a-form-model-item label="隐患编号">
          <a-input v-model="formInline.dangerCode" placeholder="请输入" allowClear></a-input>
        </a-form-model-item>
        ...
        <a-form-model-item label="责任人">
          <a-input v-model="formInline.personName" placeholder="请输入" allowClear></a-input>
        </a-form-model-item>
        <a-form-model-item label="责任部门">
          <a-input v-model="formInline.deptName" placeholder="请输入" allowClear></a-input>
        </a-form-model-item>
    ...
    <div>
      <a-tabs default-active-key="1" @change="callback" :tabBarGutter="5">
        ...
        <a-tab-pane key="2" tab="待核实"></a-tab-pane>
        <a-tab-pane key="3" tab="待确认"></a-tab-pane>
        <a-tab-pane key="4" tab="待整改"></a-tab-pane>
        <a-tab-pane key="5" tab="待复核"></a-tab-pane>
        <a-tab-pane key="6" tab="待关闭"></a-tab-pane>
...
import SelTable from "@/components/selTable/selTable.vue";
...
export default {
  ...
  data() {
    return {
      ...
      dictionary,
      actions: `${process.env.VUE_APP_API_BASE_URL}/ziehs-safeManage/api/ehs/risk/detail/specific/importUser`,
      formInline: {
        timeArr: [],
      },
      selectModel: false,
  ...
  methods: {
    callback(key) {
      if(key == 1){
        ...
        this.formInline.processStatus = 'verification'
        this.iSearch()
      } else if (key == 3){
        this.formInline.processStatus = 'confirmation'
        this.iSearch()
      } else if (key == 4){
        this.formInline.processStatus = 'rectification'
        this.iSearch()
      } else if (key == 5){
        this.formInline.processStatus = 'hdreview'
        this.iSearch()
      } else if (key == 6){
        this.formInline.processStatus = 'hdclose'
        this.iSearch()
      } else if (key == 7){
        this.formInline.processStatus = 'close'
        this.iSearch()
      }
    },
    initConfigPage(){
