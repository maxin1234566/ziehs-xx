    ...
    <div>
      <div class="title">
        ...
        <div class="title-right">
          <a-checkbox v-model="formInline.isSummary" @change="summaryChange"
            >汇总</a-checkbox
          >
        </div>
      </div>
      ...
      <a-form-model layout="inline" :model="formInlineTwoObj" :colon="false">
        ...
        <a-form-model-item label="部门">
          <a-tree-select
            ...
            :tree-data="deptList"
            :replaceFields="{ title: 'name', key: 'id', value: 'id' }"
            :placeholder="formInlineTwoObj.corporationId ? '请选择' : '请先选择所属组织'"
          ></a-tree-select>
        </a-form-model-item>
        <a-form-model-item label="月份">
          <el-date-picker
            v-model="formInlineTwoObj.mouthTime"
            type="month"
            placeholder="选择月"
            class="mouthEl"
          ></el-date-picker>
        ...
        <a-form-model-item class="float-right">
          <a-button type="primary" :loading="loadingTwo" @click="iSearchTwo"
            >查询</a-button
          >
        ...
        <div class="title">
          ...
          <div class="title-right">
            ...
            <a-radio-group v-model="formInlineTwoObj.compType" @change="compTypeChange">
              ...
              <a-radio value="2">环比</a-radio> </a-radio-group
            >&nbsp;&emsp;
            <a-checkbox v-model="formInlineTwoObj.isSummary" @change="summaryChangeTwo"
              >汇总</a-checkbox
            >
          </div>
        </div>
