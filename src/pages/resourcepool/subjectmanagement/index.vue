  ...
  <div class="clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
    ...
    >
      ...
      >
        ...
        <div slot="action" slot-scope="record">
          <span class="color-0067cc cursor-pointer m-r-15" @click="handelContent(record)"
            >內容管理</span
          >
    ...
    <CommonModal :title="editText" :visible="editVisible" :cancelFn="editCancle">
      <template slot="form">
        ...
        >
          <NewCommonSearchItem
            :CommonFormInline="editSubjectForm"
            :rules="addSubjectRules"
            :notTablePage="true"
  ...
  methods: {
    ...
    editConfirm() {
      if (!formValidator.formAll(this, "editForm")) {
        ...
        updateSubject({
          ...
          centerName: this.editSubjectForm.centerName,
          corporationId: this.editSubjectForm.corporationId,
          corporationName: this.editSubjectForm.corporationName,
    ...
    handelStatus(e) {
      ...
      updateSubject({
        ...
        corporationName: e.corporationName,
    ...
    addConfirm(ref) {
      if (!formValidator.formAll(this, "addForm")) {
        ...
        insertSubject({
          ...
          centerName: this.addForm.centerName,
          corporationId: this.addForm.corporationId,
          corporationName: this.addForm.corporationName,
          // subjectId: null,
