    ...
    <SearchTerm>
      <a-form-model layout="inline" :model="formInline" :colon="false">
        ...
        <a-form-model-item label="姓名/手机号">
          <a-input v-model="formInline.nameOrPhone" placeholder="请输入姓名/手机号" allowClear></a-input>
        </a-form-model-item>
      ...
      <template slot="form">
        ...
        >
          ...
          <a-form-model-item class="flex" label="讲师姓名" prop="name">
            <a-input v-model="editForm.name" placeholder="请输入讲师姓名" allowClear/>
          </a-form-model-item>
          <a-form-model-item class="flex" label="讲师性别">
            <a-select v-model="editForm.gender" placeholder="请选择性别" allowClear>
          ...
          <a-form-model-item class="flex" label="手机号" prop="phone">
            <a-input v-model="editForm.phone" placeholder="请输入手机号" allowClear></a-input>
          </a-form-model-item>
