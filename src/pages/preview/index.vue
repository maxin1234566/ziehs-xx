          ...
          <div class="list-detail">
            ...
            <ul v-if="noticeList.length > 0">
              <li
                ...
                :key="item.id"
                @click="noticePreview(item.id)"
              >
                <div class="title" :title="item.policyLawSubject">
                  {{ item.policyLawSubject }}
                </div>
                <div class="time">
            ...
            <div>
              <a-tabs default-active-key="1">
                <a-tab-pane v-for="item of policyTabs" :key="item.id" :tab="item.name">
                  ...
                  <ul>
                    <li
                      v-for="value of item.policyList"
                      :key="value.id"
                      @click="policyPreview(value.id)"
                    >
      ...
      <a-col :span="rowObj.colRightSpan">
        <div class="education box1">
          ...
          <div class="edu-detail">
            <router-link
              class="count-box"
              to="/ehsGerneralManage/educationmanagement/coursemanagement"
            >
            ...
            <router-link
              class="count-box"
              to="/ehsGerneralManage/educationmanagement/testManagement"
            >
              <div class="count-ico-box">
            ...
            <router-link
              class="count-box"
              to="/ehsGerneralManage/educationmanagement/coursewaremanagement"
            >
              <div class="count-ico-box">
            ...
            <router-link
              class="count-box"
              to="/ehsGerneralManage/educationmanagement/questionbankmanagement"
            >
              <div class="count-ico-box">
            ...
            <router-link
              class="count-box"
              to="/ehsGerneralManage/educationmanagement/examinationPaper"
            >
              <div class="count-ico-box">
            ...
            <router-link
              class="count-box"
              to="/ehsGerneralManage/educationmanagement/instructormanagement"
            >
              <div class="count-ico-box">
        ...
        <div class="grade-box box1">
          <div class="title-content">
            <div class="title">
              EHS管理绩效评价 ({{
                machChineseLang[quarter] == "四" ? year - 1 : year
              }}年第{{ machChineseLang[quarter] }}季度)
            </div>
          </div>
          <div class="edu-detail">
...
import {
  SelectPolicylaw,
  selectPolicy,
  getPreviewPerformanceAppraisalApi,
...
export default {
  ...
  data() {
    return {
      ...
      // dateStr: '2022-11',
      dateStr: dayJs().subtract(1, "month").format("YYYY-MM"),
    };
  },
  created() {
    ...
    const formattedFirstDayOfMonth = `${year}-${month}-01`; //当前月份的1号
    // 格式化当日日期为 "YYYY-MM-DD" 格式
    const formattedCurrentDate = currentDate.toISOString().slice(0, 10); //当日日期
    this.formInline.startTime = formattedFirstDayOfMonth;
    this.formInline.endTime = formattedCurrentDate;
  ...
  methods: {
    ...
    getPreviewPerformanceAppraisalFn() {
      let apiData = {
        year: this.quarter == 4 ? this.year - 1 : this.year,
        // year: 2022,
        quarter: this.quarter,
        // quarter: 3,
      };
      console.log(this.year, "this.year", this.quarter, "this.quarter");
    ...
    //政策法规
    async getPolicyList() {
      // console.log('999999999999','11111111111')
      const data = await selectPolicy();
      // console.log(data, 'datadatatattttttttttttttttttttttttt')
      // cconsole.log(data.data,'政策法规数据')
