<template>
    ...
    <div class="searchtable-wrapper clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
        ...
        <vxe-table border
            ...
            <vxe-column v-for="i in titleList"
                        :key="i.id"
                        :field="i.id"
                        minWidth="160"
                        :title="i.orgAbbrName">
    ...
    methods: {
        ...
        async getCarbonemissions () {
            ...
            for (let list of res) {
                ...
                //  else if (code == 1100) {
                //     boeList[2] = list;   注释原因：老厂务也没有这个相关1100 的数据
                // } 
                else if (code == 9999) {
                    boeList[2] = list;
                } else if (code == 1097) {
            ...
            // console.log('this.boeTableDataListScccc 缺少1100 待补充',boeList);
            const data1 = [];
            const data2 = [];
            const data3 = [];
            for (let item of res) {
        ...
        async getSubmodule () {
            ...
            console.log('objScc@111',titleList);
            ...
            // console.log('this.subData 看看这个缺不缺 1100',this.subData);
            const title = [];
            const xAxisData = [];
            ...
            console.log('titleScc',title,'xAxisDataSCcc',xAxisData);
            // x轴
