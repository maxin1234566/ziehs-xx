  ...
  <div class="searchtable-wrapper clx-show-scroll clx-flex-1 beauty-scroll bg-fff">
    <SearchTerm>
      <a-form-model layout="inline" :model="formInline" :colon="false">
        ...
        <a-form-model-item label="部门">
          <DeptTree allowClear :placeholder="formInline.corporationId ? '请选择':'请先选择所属组织'" v-model="formInline.deptId" :deptData="deptData" :disabled="!formInline.corporationId"></DeptTree>
        </a-form-model-item>
        ...
        <a-form-model-item label="工号">
          <a-input v-model.trim="formInline.userId" :maxLength="30" placeholder="请输入工号" allowClear></a-input>
        </a-form-model-item>
    ...
    <CommonTable :spinning="tableSpinning" :page="page" :pageNoChange="pageNoChange" :showSizeChange="showSizeChange">
      <vxe-table class="vxe-scrollbar beauty-scroll-fireBox" border show-header-overflow show-overflow align="center" :row-config="{isHover: true}" :data="tableList">
        ...
        <vxe-column field="userId" :min-width="120" title="工号"></vxe-column>
...
export default {
  ...
  methods: {
    ...
    iSearch() {
      ...
      if (this.formInline.userId && this.formInline.userId.length < 5) {
