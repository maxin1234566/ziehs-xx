                  ...
                  <div class="item_left">
                    <img
                      :src="
                        item.coverUrl
                          ? item.coverUrl
                          : 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fup.enterdesk.com%2Fedpic_source%2F9e%2F32%2F9a%2F9e329acc0c79523b0204f6ed7ea1e45e.jpg&refer=http%3A%2F%2Fup.enterdesk.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1656225906&t=b23453b4f502773672e7f27ffc36ba5b'
                      "
                      alt
                    />
                  </div>
          ...
          <a-col :span="12">
            ...
            >
              <div class="exam-time">
                <div class="display_div">
                  <a-input
                    v-model="policyForm.examinationTime"
                    placeholder="请输入考试时间"
                  ></a-input>
                  <div style="padding-left: 10px; width: 60px">分钟</div>
                </div>
                <div class="tips">
                  限制考试时长的情况下，员工考试中离开，倒计时不会停止，建议提醒员工不要长时间离开考试
                </div>
              </div>
            </a-form-model-item>
            <a-form-model-item
              label="参与考试次数"
              :prop="policyForm.limitFrequency == 1 ? 'limitFrequency' : 'frequency'"
              :label-col="labelCol"
              :wrapper-col="wrapperCol"
            >
              <div>
            ...
            >
              <div class="exam-time">
                <div class="display_div">
                  <a-input
                    v-model="policyForm.timeInterval"
                    placeholder="请输入重考时间间隔"
                  ></a-input>
                  <div style="padding-left: 10px; width: 60px">分钟</div>
                </div>
...
export default {
  components: { Editor, UploadCanRemove, CorrelativeCourse },
  props: ["examData"],
  data() {
    return {
      height: "300px",
  ...
  computed: {
    ...
    addDisabledBtn() {
      ...
      } else if (this.policyForm.topicType == 2 || this.policyForm.topicType == 3) {
        //多选、单选
    ...
    examRules() {
      let examRules = {
        ...
        topicScore: [{ required: true, message: "题目分值不能为空", trigger: "change" }],
        answer: [{ required: true, message: "答案展示不能为空", trigger: "change" }],
      };
      return examRules;
    },
  },
