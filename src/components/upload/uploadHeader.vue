...
export default {
  ...
  data() {
    return {
      ...
      limit: 1,
      //请求地址
      action: window.location.host.indexOf('localhost') < 0 ? `${process.env.VUE_APP_API_PROXY_TARGET}/ziehs-sysManage/api/file/uploadFile` : `ziehs-sysManage/api/file/uploadFile`,
      // 文件类型
