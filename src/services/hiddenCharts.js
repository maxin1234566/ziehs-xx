...
let front = serviceNameList['safeManagement']
...
// 危险作业楼层楼栋带数量
export const dangerSenceCategoryTreeData = params => post(front + '/api/ehs/safe/danger/sence/categoryTree/data', params);
// 左下角数量接口
export const dangerOperateNum = params => post(front + '/api/ehs/safe/danger/operate/num', params);
// 查询报警区域接口 /danger/select/byType
export const dangerSelectByType = params => post(front + '/api/ehs/safe/danger/select/byType', params);
//应急演练
//应急演练类型
export const GetStatisticsChartsTypeCookie = params => post('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/type/cookie', params);
//应急演练类型-导出
export const ExoprtStatisticsChartsTypeCookie = params => postExcel('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/type/cookie/download', params);
//应急演练级别
export const GetStatisticsChartsLeveCookie = params => post('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/level/cookie', params);
//应急演练级别-导出
export const ExoprtStatisticsChartsLeveCookie = params => postExcel('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/level/cookie/download', params);
//应急演练级别数据柱图
export const GetStatisticsChartsLeveBar = params => post('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/level/bar', params);
//应急演练级别数据柱图-导出
export const ExoprtStatisticsChartsLeveBar = params => postExcel('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/level/bar/download', params);
//应急演练类型数据柱图
export const GetStatisticsChartsTypeBar = params => post('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/type/bar', params);
//应急演练类型数据柱图-导出
export const ExoprtStatisticsChartsTypeBar = params => postExcel('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/type/bar/download', params);
//应急演练总览
export const GetStatisticsChartsOverviewBar = params => post('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/overview/bar', params);
//应急演练总览-导出
export const ExoprtStatisticsChartsOverviewBar = params => postExcel('ziehs-safeManage/api/ehs/danger/data/analysis/drill/statistics/overview/bar/download', params);