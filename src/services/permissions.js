...
//申请人列表
export const GetUserInfoList = params => post(`ziehs-sysManage/api/company/user/info/page/list`, params);
//移除事件
export const DelUserInfoList = params => post(`${serviceNameList.systemManagement}/api/company/user/info/delete`, params);

//用户新增/详情弹框中自定义字段接口
export const CustomField = params => get(`ziehs-customer/api/custome/fields/list`, params);
...
//新增用户/编辑用户接口
export const AddUserOrEditInterface = params => post(`ziehs-sysManage/api/company/user/info/edit`, params);

//用户回显
export const UserDetailInterFace = params => get(`ziehs-sysManage/api/company/user/info/echo`, params);

//用户回显
export const DeptDetailInterFace = params => get(`ziehs-sysManage/api/enterprise/dept/echo`, params);
