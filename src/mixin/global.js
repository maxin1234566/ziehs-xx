            ...
            if (!flag) {
                return {
                    ...
                    customRender: (text, row, index) => {
                        ...
                        let list = orgList.filter((item) => {
                            // console.log(item.companyId, row.corporationId)
                            return item.orgId == row.corporationId
                        })
                        if (list && list.length) {
            ...
            if (!flag) {
                return {
                    ...
                    customRender: (text, row, index) => {
                        ...
                        // let deptCache = JSON.parse(sessionStorage.getItem('deptCache'))
                        // console.log(deptCache,'deptCachedeptCachedeptCache')
